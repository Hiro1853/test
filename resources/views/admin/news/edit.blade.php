            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action="{{ action('Admin\NewsController@update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            value="{{ optional($news_form)->title }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" name="body" rows="20">
                              {{  optional($news_form)->body }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="form-text text-info">
                                設定中: {{ optional($news_form)->image_path }}
                            </div>
                ...
                <div class="row mt-5">
                  <div class="col-md-4 mx-auto">
                    <h2>編集履歴</h2>
                    <ul class="list-group">
                      @if (optional($news_form)->histories != NULL)
